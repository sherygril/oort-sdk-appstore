...
public class ToastUtil {
    ...
    public static void showErrorNet(Context context) {
        showToast(context, R.string.base_net_exception);
    }
    ...
    public static void showErrorData(Context context) {
        ...
        realShowToast(context, context.getString(R.string.base_data_exception), Toast.LENGTH_SHORT);
    }
    ...
    public static void showNetError(Context context) {
        ...
        realShowToast(context, context.getString(R.string.base_request_exception), Toast.LENGTH_SHORT);
    }
    ...
    public static void showUnkownError(Context ctx, Throwable t) {
        ...
        showToast(ctx, ctx.getString(R.string.base_tip_unkown_error_place_holder, message));
    }
