package com.oortcloud.basemodule.login.okhttp.builder;
...
public abstract class BaseBuilder {
    ...
    protected String getUserAgent() {
        ...
        result.append("1.1.0"); // such as 1.1.0//BuildConfig.VERSION_NAME
    ...
    public BaseBuilder addMac(Boolean beforeLogin) {
        LoginTool.generateHttpParam(null, params, beforeLogin);
        return this;
    }
